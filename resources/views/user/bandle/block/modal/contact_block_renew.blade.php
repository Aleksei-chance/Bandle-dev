<div class="hover_modal" id="bandle_contact_block_renew">
    <div class="modal_body" style="padding: 0 0 8px 0;">
        ...
        <div class="modal_content" style="gap: 0" id="contact_block_content">
            @include('user.bandle.block.modal.contact_block_renew_content')
        </div>
...
<script>
    $('#bandle_contact_block_renew').modal('show');
</script>